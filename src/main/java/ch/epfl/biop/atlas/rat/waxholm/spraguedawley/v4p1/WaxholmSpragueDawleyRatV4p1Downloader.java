...
public class WaxholmSpragueDawleyRatV4p1Downloader {
    ...
    static public URL getMapUrl() {
        ...
        File fileXml = new File(AtlasLocationHelper.cachedSampleDir, "WHS_SD_rat_atlas_v4p1.xml");
        File fileHdf5 = new File(AtlasLocationHelper.cachedSampleDir, "WHS_SD_rat_atlas_v4p1.h5");
        ...
        try {
            if (dlXml) DownloadProgressBar.urlToFile(new URL(wh_sd_rat_v4p1_xml), new File(AtlasLocationHelper.cachedSampleDir, "WHS_SD_rat_atlas_v4p1.xml"), "Downloading WHS_SD_rat_atlas_v4p1.xml", -1);
            if (dlH5) DownloadProgressBar.urlToFile(new URL(wh_sd_rat_v4p1_hdf5), new File(AtlasLocationHelper.cachedSampleDir, "WHS_SD_rat_atlas_v4p1.h5"), "Downloading WHS_SD_rat_atlas_v4p1.h5", 601_500_109L);
    ...
    public static URL getOntologyURL() {
        File ontologyFile = new File(AtlasLocationHelper.cachedSampleDir, "WHS_SD_rat_atlas_v4_labels.ilf");
        ...
        try {
            if (dlOntology) DownloadProgressBar.urlToFile(new URL(wh_sd_rat_v4_ontology), new File(AtlasLocationHelper.cachedSampleDir, "WHS_SD_rat_atlas_v4_labels.ilf"), "Downloading ontology", -1);
