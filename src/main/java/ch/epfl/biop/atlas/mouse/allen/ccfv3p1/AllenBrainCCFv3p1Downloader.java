...
public class AllenBrainCCFv3p1Downloader {
    ...
    static public URL getMapUrl() {
        ...
        File fileXml = new File(AtlasLocationHelper.cachedSampleDir, "mouse_brain_ccfv3p1.xml");
        ...
        try {
            if (dlXml) DownloadProgressBar.urlToFile(new URL(allen_mouse_brain_CCFv3p1_xml_v1), new File(AtlasLocationHelper.cachedSampleDir, "mouse_brain_ccfv3p1.xml"), "Downloading mouse_brain_ccfv3p1.xml", -1);
